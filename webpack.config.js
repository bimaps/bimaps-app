...
const plugins = ['aurelia-deco', 'aurelia-resources', 'aurelia-bcf'];
const useSrcFor = [];
...
.concat(['aurelia-resources','aurelia-deco', 'aurelia-bcf'])
...
// list resources for plugins in SRC mode
  ...(useSrcFor.reduce(
    ...
    new CopyWebpackPlugin([
      { from: './images/**/*', to: './' },
      { from: './fonts/**/*', to: './' },
      { from: "node_modules/web-ifc/web-ifc.wasm", to: "files" },
      { from: "node_modules/web-ifc-three/IFCWorker.js", to: "files" },
    ]),
    ...when(!tests, new CopyWebpackPlugin([
      { from: 'static', to: outDir },
      { from: 'signage', to: outDir + '/signage' },

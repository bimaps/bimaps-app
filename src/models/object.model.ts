...
export class ThreeObjectModel extends Model {
  ...
  @type.array()
  public matrixWorld: Array<number>;
    ...
    return super.getAll(suffix, options).then((el) => {
      ...
      for (let element of elements) {
        if (element instanceof ThreeObjectModel) {
          ...
          element.userData.building = element.building;
          element.userData.storey = element.storey;
          element.userData.space = element.space;
          element.userData.context = element.context;
        }
      }
  ...
  static fromThreeObject(object: THREE.Object3D) {
    ...
    obj.matrixWorld = object.matrixWorld.elements;
